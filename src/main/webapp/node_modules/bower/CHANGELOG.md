...
- Allow for node_modules to be a symlink
...
- Bower no longer fails if `symlinks` to files are present in the `node_modules` folder ([#783](https://github.com/bower/bower/issues/783) and [#791](https://github.com/bower/bower/issues/791))
...
- __Change bower default folder from `components` to `node_modules`__ ([#434](https://github.com/bower/bower/issues/434))
